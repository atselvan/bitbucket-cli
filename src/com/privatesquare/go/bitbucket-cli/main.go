...
import (
	b "com/privatesquare/go/bitbucket-cli/backend"
...
func main() {
	...
	deactivateInactiveUsers := flag.Bool("deactivateInactiveUsers", false, "Deactivate the list of users who have not logged in since 3 months")
	...
	} else if *deactivateInactiveUsers == true {
		b.DeactivateInactiveUsers(*bitbucketURL, user, *verbose)
